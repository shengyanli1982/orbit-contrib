...
func TestPathOverwriter_PathRewrite(t *testing.T) {

	// Create a new Config
	conf := NewConfig().WithPathRewriteFunc(func(header *http.Request) (bool, string) {
		if header.URL.Path == com.TestUrlPath {
...
func TestPathOverwriter_MatchFunc(t *testing.T) {}

func TestPathOverwriter_IpWhitelistWithLocal(t *testing.T) {}

func TestPathOverwriter_IpWhitelistWithOther(t *testing.T) {}
